...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, DataTransferProtocol, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func randomNews() {
        let news1 = News(text: "", image: newsImageArray[0], likesCount: newsLikesArray[0], commentsCount:newsCommentsArray[0], repostsCount: newsRepostsArray[0], name: nameLabel.text!, surname: surnameLabel.text!, date: newsDateArray[Int(arc4random_uniform(UInt32(newsDateArray.count)))] )
        let news2 = News(text: newsTextArray[1], image: nil, likesCount: newsLikesArray[1], commentsCount:newsCommentsArray[1], repostsCount: newsRepostsArray[1], name: nameLabel.text!, surname: surnameLabel.text!, date: newsDateArray[Int(arc4random_uniform(UInt32(newsDateArray.count)))])
